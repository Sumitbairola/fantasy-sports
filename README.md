...
A modern, full-stack fantasy cricket team builder with advanced state management, real-time validation, and persistent data storage.

## 📄 Project Overview

This responsive web application simulates a complete fantasy sports experience, allowing users to browse upcoming cricket matches, build teams with strategic constraints, and manage multiple team configurations. Built with Next.js and Redux, it demonstrates production-ready frontend architecture with complex business logic implementation.

**Live Demo:** [https://fantasy-sports-6z282gyh4-sumit-bairolas-projects.vercel.app](https://fantasy-sports-6z282gyh4-sumit-bairolas-projects.vercel.app)
...
The project includes a `.env` file with public API endpoints. For Vercel deployment, add these variables in 

**Settings → Environment Variables**:

NEXT_PUBLIC_MATCHES_API=https://leaguex.s3.ap-south-1.amazonaws.com/task/fantasy-sports/Get_All_upcoming_Matches.json
NEXT_PUBLIC_PLAYERS_API=https://leaguex.s3.ap-south-1.amazonaws.com/task/fantasy-sports/Get_All_Players_of_match.json
...
The application is deployed on [Vercel](https://vercel.com/). Connect your GitHub repository to Vercel, and it will automatically detect Next.js and handle the build process.

Access the live application here: [Fantasy Sports Application]
(https://fantasy-sports-6z282gyh4-sumit-bairolas-projects.vercel.app/)
